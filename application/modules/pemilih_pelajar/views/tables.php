                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="<?php echo base_url()?>pemilih_pelajar/import-excel" method="POST" id="import" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="field-3" class="control-label">Format Import Excel</label>
                                                <a href="<?php echo base_url()?>pemilih_pelajar/download-source" target="_blank" style="width:100%" class="btn btn-orange waves-light waves-effect width-md"><i class="ion ion-md-cloud-download"></i> Download Format</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
