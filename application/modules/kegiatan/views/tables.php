        ...
        <div class="card">
            <div class="card-header bg-light">
                <h4 class="header-title mb-3"><b>Tabel <?php echo $title?></b>
                    <a href="<?php echo base_url()?>kegiatan/tambah-kegiatan" class="btn btn-primary float-right">
                ...
                <div class="row mb-2">
                    <div class="col-lg-4">
                        <div class="form-group row">
                            <label class="col-lg-3 control-label mt-2" for="filter_jenis_kegiatan">Jenis Kegiatan</label>
                            <div class="col-lg-9">
                                <select name="filter_jenis_kegiatan" id="filter_jenis_kegiatan" class="required form-control">
