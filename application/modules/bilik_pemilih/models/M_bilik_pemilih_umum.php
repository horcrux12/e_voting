...
class M_bilik_pemilih_umum extends CI_Model {
    ...
    {   
        ...
        $search_filter[] = " data_pemilih_umum.status='1'";
		...
		foreach ($records as $field) {
            ...
            $row ['status']         = $status;
            $row ['action']         = '<button title="Pilih" class="btn btn-primary waves-effect waves-light btn-xs button" style="margin-bottom:5px" data-nama="'.$field['nama'].'" data-id="'.$field['no_identitas'].'"><i class="fas fa-angle-double-right"></i></button>';
            $data[] = $row;
        }
